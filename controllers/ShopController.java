...
public class ShopController {
    ...
    public String shopPage(Model model, @PathVariable(name = "filterType") String filterType) {
        List<Product> filteredProducts = productService.getFilteredProducts(filterType);
